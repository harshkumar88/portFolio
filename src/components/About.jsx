        ...
        <div style={{backgroundColor:"white",minHeight:"100vh",overflow:"hidden"}}>
            ...
            <div className="move container text-center">
                ...
                <div style={{display:"flex",justifyContent:"space-around",marginTop:'4%',marginBottom:"5%",flexWrap:"wrap"}} className="container">
                    ...
                    <div style={{textAlign:"justify",marginTop:"3%",width:'40%'}}><p style={{fontWeight:"bold"}} >As a web developer, my name is Harsh.</p><span >I am currently a second-year student at Chitkara University pursuing a bachelor's in engineering. I am learning many languages, including HTML, CSS, Javascript, Bootstrap, JQuery, React, MongoDb, and Node.js. </span><br/>
                    <br/>
